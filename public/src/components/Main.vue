...
export default {
  ...
  methods: {
    ...
    async sendmail() {
      ...
      const result = await axios.post('https://email-service-node.herokuapp.com/sendmail', formData);
    ...
    loadHistory() {
      axios.get('https://email-service-node.herokuapp.com/history').then((res) => {
